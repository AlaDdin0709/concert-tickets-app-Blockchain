...
>(({ className, children, showCloseButton = true, ...props }, ref) => (
  <DialogPortal data-slot="dialog-portal">
    <DialogOverlay />
    {/* Make the Radix Content element a full-screen flex container so we can center
        the visual panel and allow the panel to be scrollable when its contents
    ...
    <DialogPrimitive.Content
      ...
      {...props}
    >
      {/* Inner visual panel: this is the element that gets the max-width, padding,
          rounded corners and crucially max-height + overflow so tall content can scroll. */}
      <div
        className={cn(
